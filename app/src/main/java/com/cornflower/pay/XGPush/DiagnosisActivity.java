package com.cornflower.pay.XGPush;
...
import com.cornflower.pay.XGPush.cloud.ClickAction;
import com.cornflower.pay.XGPush.cloud.Style;
import com.cornflower.pay.XGPush.cloud.TimeInterval;
import com.cornflower.pay.XGPush.cloud.XingeApp;
import com.cornflower.pay.XGPush.common.CommonWorkingThread;
import com.cornflower.pay.XGPush.common.ExtendedListView;
...
//			}
	...
	private void step7() {
		...
		int ret_code = 0;
		try {
			com.cornflower.pay.XGPush.cloud.Message message = new com.cornflower.pay.XGPush.cloud.Message();
			message.setType(com.cornflower.pay.XGPush.cloud.Message.TYPE_NOTIFICATION);
