...
import com.cornflower.pay.XGPush.common.NotificationService;
import com.cornflower.pay.XGPush.po.XGNotification;
...
public class MainActivity extends Activity implements OnItemClickListener,
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// 注册接口
		XGPushManager.registerPush(getApplicationContext(),"18550073882",
	...
	private void initCustomPushNotificationBuilder(Context context) {
		...
		build.setContentIntent( PendingIntent.getActivity(this, 0, intent, 0));
		XGPushManager.setDefaultNotificationBuilder(this,build);
		Log.i("XGPushManager","XGPushManager");
	...
	private static class HandlerExtension extends Handler {
		...
		public void handleMessage(Message msg) {
			...
			if (msg != null) {
				...
				Log.i("getToken",XGPushConfig.getToken(theActivity));
			}
